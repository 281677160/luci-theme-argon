...
## 预览
![macOS](https://github.com/thinktip/luci-theme-neobird2/blob/main/preview/SCR-20220223-iw6.png)
![macOS](https://github.com/thinktip/luci-theme-neobird2/blob/main/preview/SCR-20220223-iwp.png)
![macOS](https://github.com/thinktip/luci-theme-neobird2/blob/main/preview/SCR-20220223-j1l.png)
![iOS](https://github.com/thinktip/luci-theme-neobird2/blob/main/preview/IMG_6478.PNG)
![iOS](https://github.com/thinktip/luci-theme-neobird2/blob/main/preview/IMG_6481.PNG)
![iOS](https://github.com/thinktip/luci-theme-neobird2/blob/main/preview/IMG_6474.PNG)
## 自行编译：

```
cd lede/package/lean  
rm -rf luci-theme-neobird2  
git clone https://github.com/thinktip/luci-theme-neobird2.git  
cd ~/lede/
make menuconfig #choose LUCI->Theme->Luci-theme-neobird2  
make -j1 V=s
```
